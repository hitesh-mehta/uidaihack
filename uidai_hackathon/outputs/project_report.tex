...
\centering \textit{[Temporal Trends Chart: Monthly aggregates for Biometric, Enrolment, and Demographic updates from 2019-2024]}
}}
...
\fbox{\parbox{0.95\textwidth}{
\centering \textit{[India Choropleth Heatmap: Biometric update density by state]}
}}
...
\fbox{\parbox{0.95\textwidth}{
\centering \textit{[Sunburst Chart: India $\rightarrow$ State $\rightarrow$ District hierarchical view]}
}}
...
\fbox{\parbox{0.95\textwidth}{
\centering \textit{[DDI Choropleth Map: Color-coded by Digital Divide Index, with intervention zones highlighted]}
}}
...
\fbox{\parbox{0.95\textwidth}{
\centering \textit{[Forecast Chart: Historical data with train/test split and 6-month projection with confidence bands]}
}}
...
\fbox{\parbox{0.95\textwidth}{
\centering \textit{[Benford's Law Chart: Expected vs Observed first-digit distribution]}
}}
